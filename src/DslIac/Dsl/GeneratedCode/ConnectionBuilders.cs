...
namespace Variamos.IacTemplateGenerator.IacLanguage
{
	...
	/// </summary>
	public static partial class VmReferencesNetworkInterfacedBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Variamos.IacTemplateGenerator.IacLanguage.Vm)
			{ 
				return true;
			}
			else
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterface)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Variamos.IacTemplateGenerator.IacLanguage.Vm)
				{
					if (candidateTarget is global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterface)
					{
						global::Variamos.IacTemplateGenerator.IacLanguage.Vm sourceVm = (global::Variamos.IacTemplateGenerator.IacLanguage.Vm)candidateSource;
						global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterface targetNetworkInterface = (global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterface)candidateTarget;
						if(targetNetworkInterface == null || sourceVm == null || global::Variamos.IacTemplateGenerator.IacLanguage.VmReferencesNetworkInterfaced.GetLinks(sourceVm, targetNetworkInterface).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Variamos.IacTemplateGenerator.IacLanguage.Vm)
				{
					if (target is global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterface)
					{
						global::Variamos.IacTemplateGenerator.IacLanguage.Vm sourceAccepted = (global::Variamos.IacTemplateGenerator.IacLanguage.Vm)source;
						global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterface targetAccepted = (global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterface)target;
						DslModeling::ElementLink result = new global::Variamos.IacTemplateGenerator.IacLanguage.VmReferencesNetworkInterfaced(sourceAccepted, targetAccepted);
	...
	/// </summary>
	internal partial class VmNetworkInterfaceToolConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new VmNetworkInterfaceToolConnectAction for the given Diagram.
		/// </summary>
		public VmNetworkInterfaceToolConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the VmNetworkInterfaceToolConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new VmNetworkInterfaceToolConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class VmNetworkInterfaceToolConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the VmNetworkInterfaceToolConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected VmNetworkInterfaceToolConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder VmReferencesNetworkInterfacedBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return VmReferencesNetworkInterfacedBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return VmReferencesNetworkInterfacedBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				VmReferencesNetworkInterfacedBuilder.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class VmNetworkInterfaceToolConnectionType : VmNetworkInterfaceToolConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the VmNetworkInterfaceToolConnectionType with the given ConnectionBuilder.
			/// </summary>
			public VmNetworkInterfaceToolConnectionType() : base() {}
		}
	}
}
