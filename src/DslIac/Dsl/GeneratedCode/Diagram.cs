...
[module: global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Scope = "type", Target = "Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDiagram")]

namespace Variamos.IacTemplateGenerator.IacLanguage
{
	/// <summary>
	/// DomainClass IacLanguageDiagram
	/// Description for Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDiagram
	/// </summary>
	[DslDesign::DisplayNameResource("Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDiagram.DisplayName", typeof(global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDomainModel), "Variamos.IacTemplateGenerator.IacLanguage.GeneratedCode.DomainModelResx")]
	[DslDesign::DescriptionResource("Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDiagram.Description", typeof(global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDomainModel), "Variamos.IacTemplateGenerator.IacLanguage.GeneratedCode.DomainModelResx")]
	[DslModeling::DomainModelOwner(typeof(global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDomainModel))]
	[global::System.CLSCompliant(true)]
	[DslModeling::DomainObjectId("ad1f4720-ac7c-4700-a17c-52efa3d6b906")]
	public partial class IacLanguageDiagram : DslDiagrams::Diagram
	{
		...
		private static global::System.ComponentModel.ToolboxItemFilterAttribute[] toolboxFilters = new global::System.ComponentModel.ToolboxItemFilterAttribute[] {
					new global::System.ComponentModel.ToolboxItemFilterAttribute(global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageToolboxHelperBase.ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) };
		...
		{
			if(element is global::Variamos.IacTemplateGenerator.IacLanguage.Vm)
			{
				global::Variamos.IacTemplateGenerator.IacLanguage.VmShape newShape = new global::Variamos.IacTemplateGenerator.IacLanguage.VmShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterface)
			{
				global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterfaceShape newShape = new global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterfaceShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::Variamos.IacTemplateGenerator.IacLanguage.VmReferencesNetworkInterfaced)
			{
				global::Variamos.IacTemplateGenerator.IacLanguage.VmNetworkInterfaceConnector newShape = new global::Variamos.IacTemplateGenerator.IacLanguage.VmNetworkInterfaceConnector(this.Partition);
				return newShape;
			}
		...
		protected override void InitializeShapeFields(global::System.Collections.Generic.IList<DslDiagrams::ShapeField> shapeFields)
		{
			...
			global::Variamos.IacTemplateGenerator.IacLanguage.VmShape.DecoratorsInitialized += VmShapeDecoratorMap.OnDecoratorsInitialized;
			global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterfaceShape.DecoratorsInitialized += NetworkInterfaceShapeDecoratorMap.OnDecoratorsInitialized;
		}
		
		/// <summary>
		/// Class containing decorator path traversal methods for VmShape.
		/// </summary>
		internal static partial class VmShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for VmShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				...
				propertyInfo = new DslDiagrams::AssociatedPropertyInfo(global::Variamos.IacTemplateGenerator.IacLanguage.AzureComponent.labelDomainPropertyId);
				DslDiagrams::ShapeElement.FindDecorator(shape.Decorators, "Label").AssociateValueWith(shape.Store, propertyInfo);
			}
		}
		
		/// <summary>
		/// Class containing decorator path traversal methods for NetworkInterfaceShape.
		/// </summary>
		internal static partial class NetworkInterfaceShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for NetworkInterfaceShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
		...
		private global::Variamos.IacTemplateGenerator.IacLanguage.VmNetworkInterfaceToolConnectAction vmNetworkInterfaceToolConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageToolboxHelper.VmNetworkInterfaceToolFilterString))
				{
					if (this.vmNetworkInterfaceToolConnectAction == null)
					{
						this.vmNetworkInterfaceToolConnectAction = new global::Variamos.IacTemplateGenerator.IacLanguage.VmNetworkInterfaceToolConnectAction(this);
						this.vmNetworkInterfaceToolConnectAction.MouseActionDeactivated += new DslDiagrams::MouseAction.MouseActionDeactivatedEventHandler(OnConnectActionDeactivated);
					}
					action = this.vmNetworkInterfaceToolConnectAction;
				} 
				else
				{
					action = null;
		...
		protected override void Dispose(bool disposing)
		{
			try
			{
				if(disposing)
				{
					if(this.vmNetworkInterfaceToolConnectAction != null)
					{
						this.vmNetworkInterfaceToolConnectAction.Dispose();
						this.vmNetworkInterfaceToolConnectAction = null;
					}
				}
			}
			finally
		...
		/// <summary>
		/// IacLanguageDiagram domain class Id.
		/// </summary>
		public static readonly new global::System.Guid DomainClassId = new global::System.Guid(0xad1f4720, 0xac7c, 0x4700, 0xa1, 0x7c, 0x52, 0xef, 0xa3, 0xd6, 0xb9, 0x06);
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="store">Store where new element is to be created.</param>
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public IacLanguageDiagram(DslModeling::Store store, params DslModeling::PropertyAssignment[] propertyAssignments)
		...
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public IacLanguageDiagram(DslModeling::Partition partition, params DslModeling::PropertyAssignment[] propertyAssignments)
...
namespace Variamos.IacTemplateGenerator.IacLanguage
{
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::Variamos.IacTemplateGenerator.IacLanguage.Vm), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterface), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::Variamos.IacTemplateGenerator.IacLanguage.VmReferencesNetworkInterfaced), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public override void ElementAdded(DslModeling::ElementAddedEventArgs e)
			{
				...
				if(childElement is global::Variamos.IacTemplateGenerator.IacLanguage.Vm)
				{
					parentElement = GetParentForVm((global::Variamos.IacTemplateGenerator.IacLanguage.Vm)childElement);
				} else
				if(childElement is global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterface)
				{
					parentElement = GetParentForNetworkInterface((global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterface)childElement);
				} else
				{
					parentElement = null;
				}
			...
			public static global::Variamos.IacTemplateGenerator.IacLanguage.IacModel GetParentForVm( global::Variamos.IacTemplateGenerator.IacLanguage.Vm root )
			{
				// Segments 0 and 1
				global::Variamos.IacTemplateGenerator.IacLanguage.IacModel result = root.IacModel;
				if ( result == null ) return null;
				return result;
			}
			public static global::Variamos.IacTemplateGenerator.IacLanguage.IacModel GetParentForNetworkInterface( global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterface root )
			{
				// Segments 0 and 1
				global::Variamos.IacTemplateGenerator.IacLanguage.IacModel result = root.IacModel;
				if ( result == null ) return null;
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::Variamos.IacTemplateGenerator.IacLanguage.AzureComponent), InitiallyDisabled=true)]
		internal sealed class DecoratorPropertyChanged : DslModeling::ChangeRule
		{
			...
			public override void ElementPropertyChanged(DslModeling::ElementPropertyChangedEventArgs e)
			{
				...
				if (e.DomainProperty.Id == global::Variamos.IacTemplateGenerator.IacLanguage.AzureComponent.labelDomainPropertyId)
				{
					DslDiagrams::Decorator decorator = global::Variamos.IacTemplateGenerator.IacLanguage.VmShape.FindVmShapeDecorator("Label");
					if(decorator != null)
					{
						decorator.UpdateDecoratorHostShapes(e.ModelElement, global::Variamos.IacTemplateGenerator.IacLanguage.Vm.DomainClassId);
					}
					decorator = global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterfaceShape.FindNetworkInterfaceShapeDecorator("Label");
					if(decorator != null)
					{
						decorator.UpdateDecoratorHostShapes(e.ModelElement, global::Variamos.IacTemplateGenerator.IacLanguage.NetworkInterface.DomainClassId);
					}
				}
			}
		}
		...
		internal sealed class ConnectorRolePlayerChanged : DslModeling::RolePlayerChangeRule
		{
			...
			public override void RolePlayerChanged(DslModeling::RolePlayerChangedEventArgs e)
			{
				...
				foreach (DslDiagrams::PresentationViewsSubject connectorLink in connectorLinks)
				{
					...
					if (linkShape != null)
					{
						global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDiagram diagram = linkShape.Diagram as global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDiagram;
						if (diagram != null)
						{
