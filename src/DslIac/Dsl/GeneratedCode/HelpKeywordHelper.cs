...
namespace Variamos.IacTemplateGenerator.IacLanguage
{
	...
	/// </remarks>
	public partial class IacLanguageHelpKeywordHelper : IacLanguageHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new IacLanguageHelpKeywordHelper.
		/// </summary>
		protected IacLanguageHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the IacLanguageHelpKeywordHelper.
		/// </summary>
		public static IacLanguageHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class IacLanguageHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new IacLanguageHelpKeywordHelperBase.
		/// </summary>
		protected IacLanguageHelpKeywordHelperBase()
			: base() { }
