...
namespace Variamos.IacTemplateGenerator.IacLanguage
{
	...
	/// </summary>
	internal partial class IacLanguageDocView : IacLanguageDocViewBase
	{
		/// <summary>
		/// Constructs a new IacLanguageDocView.
		/// </summary>
		public IacLanguageDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class IacLanguageDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new IacLanguageDocView.
		/// </summary>
		protected IacLanguageDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			IacLanguageDocDataBase docData = this.DocData as IacLanguageDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for IacLanguageDocViewBase should be an IacLanguageDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.IacLanguageDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
