...
namespace Variamos.IacTemplateGenerator.IacLanguage
{
	...
	/// </summary>
	internal partial class IacLanguageDocData : IacLanguageDocDataBase
	{
		/// <summary>
		/// Constructs a new IacLanguageDocData.
		/// </summary>
		public IacLanguageDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a IacLanguage document in memory.
	/// </summary>
	internal abstract partial class IacLanguageDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new IacLanguageDocDataBase.
		/// </summary>
		protected IacLanguageDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Variamos.IacTemplateGenerator.IacLanguage.IacModel modelRoot = null;
			...
			global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Variamos.IacTemplateGenerator.IacLanguage.IacModel modelRoot = (global::Variamos.IacTemplateGenerator.IacLanguage.IacModel)this.RootElement;
			...
			{
				global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDiagram diagram = diagrams[0] as global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Variamos.IacTemplateGenerator.IacLanguage.IacModel modelRoot = this.RootElement as global::Variamos.IacTemplateGenerator.IacLanguage.IacModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Variamos.IacTemplateGenerator.IacLanguage.IacLanguageSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
