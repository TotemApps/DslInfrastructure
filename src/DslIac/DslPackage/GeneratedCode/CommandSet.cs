...
namespace Variamos.IacTemplateGenerator.IacLanguage
{
	...
	/// </summary>
	internal partial class IacLanguageCommandSet : IacLanguageCommandSetBase
	{
		/// <summary>
		/// Constructs a new IacLanguageCommandSet.
		/// </summary>
		public IacLanguageCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class IacLanguageCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new IacLanguageCommandSetBase.
		/// </summary>
		protected IacLanguageCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewIacLanguageExplorerCommand,
				typeof(IacLanguageEditorFactory).GUID);
		...
		{
			IacLanguageExplorerToolWindow explorer = this.IacLanguageExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected IacLanguageDocData CurrentIacLanguageDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as IacLanguageDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected IacLanguageDocView CurrentIacLanguageDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as IacLanguageDocView;
			}
		}
		...
		/// </summary>
		protected IacLanguageExplorerToolWindow IacLanguageExplorerToolWindow
		{
			get
			{
				IacLanguageExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(IacLanguageExplorerToolWindow), true) as IacLanguageExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				IacLanguageExplorerToolWindow explorerWindow = this.IacLanguageExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class IacLanguageClipboardCommandSet : IacLanguageClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new IacLanguageClipboardCommandSet.
		/// </summary>
		public IacLanguageClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class IacLanguageClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new IacLanguageClipboardCommandSetBase.
		/// </summary>
		protected IacLanguageClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
