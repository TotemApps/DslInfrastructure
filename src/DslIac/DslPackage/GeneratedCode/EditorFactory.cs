...
namespace Variamos.IacTemplateGenerator.IacLanguage
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.IacLanguageEditorFactoryId)]
	internal partial class IacLanguageEditorFactory : IacLanguageEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new IacLanguageEditorFactory.
		/// </summary>
		public IacLanguageEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class IacLanguageEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected IacLanguageEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new IacLanguageDocData(this.ServiceProvider, typeof(IacLanguageEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new IacLanguageDocView(docData, this.ServiceProvider);
		}
	}
}
